...
for case in IDLIST:
    ...
    # predict_patch(case)
    for AI in AImodels:
        with open('C:\\Users\\Moon\\Desktop\\' + str(case) + '_' + str(AI) +'.pkl', 'rb') as f:
            cases = pickle.load(f)
            ...
            for i in range(4):
                ...
                print(percenlist[i])
            if sum(cases[:, 3]) >= 1:
                print('Case number ' + str(case) + ' with the AI number ' + str(AI) + ' is diagnosed as SCC')
            elif sum(cases[:, 2]) >= 1:
                print('Case number ' + str(case) + ' with the AI number ' + str(AI) +' is diagnosed as high grade dysplasia')
            elif sum(cases[:, 1]) >= 1:
                print('Case number ' + str(case) + ' with the AI number ' + str(AI) +' is diagnosed as low grade dysplasia')
            else:
                print('Case number ' + str(case) + ' with the AI number ' + str(AI) +' is diagnosed as normal')
            print(len(cases))
            endprocess_message()
        print(' ')
